...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "CRowdCLassic-seeder\n"
...
static const string mainnet_seeds[] = {"seeds.crcl.dns-cloud.net", ""};
static const string testnet_seeds[] = {"testnet-seeds.crcl.dns-cloud.net",  ""};
